...
//let insert =(Console.ReadLine()|>Convert.ToInt32,Console.ReadLine()|>Convert.ToInt32)
//let res = chooseFunc(fst insert)(snd insert)
...
[<EntryPointAttribute>]
let main arg = 
       Console.WriteLine("Select function > insert value")
       let insert =(Console.ReadLine()|>Convert.ToInt32,Console.ReadLine()|>Convert.ToInt32)
       let res = chooseFunc(fst insert)(snd insert)
       print(res)
       0
